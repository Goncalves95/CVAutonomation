    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-10 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-gray-900 text-lg">CV Generator</h1>
        </div>
        <div className="flex items-center gap-3">
          <button
      ...
      <main className="flex flex-1 overflow-hidden" style={{ height: 'calc(100vh - 73px)' }}>
        {/* Form panel */}
        <div
          className={`overflow-y-auto bg-white border-r border-gray-200 transition-all ${
            showPreview ? 'w-full md:w-[480px] lg:w-[520px]' : 'w-full'
          }`}
        >
